...
aggregate(cbind(`Arts and Humanities`,`Business and Economics`,Education,`Science & Technology`,`Social Sciences`,`University-wide`)~StdntCollege,data = Major_Course_College_Pivot,FUN = "sum")
