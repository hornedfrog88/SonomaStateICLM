...
test <- Major_Course_College_Pivot %>% group_by(StdntCollege) %>% summarise(sum(`Arts and Humanities`,`Business and Economics`,Education,`Science & Technology`,`Social Sciences`,`University-wide`))
...
#Insert the Subtotals into the Major_Course_College_Pivot data frame
Major_Course_College_Pivot[4,]<- Subtotals_by_College[1,]
