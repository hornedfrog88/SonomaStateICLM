...
Subtotals_by_College <- Subtotals_by_College %>% select(StdntCollege,Major,`Arts and Humanities`,`Business and Economics`,`Extended Education`,Education,`Science & Technology`,`Social Sciences`,`University-wide`)
rbind(Subtotals_by_College[1,],Major_Course_College_Pivot[3,])
